...
Route::post('/counseling/store', [CounselingController::class, 'store'])->name('counseling.store');
    ...
    Route::get('/note/{lecture_id}', [NoteController::class, 'getNote'])->name('note.get');
...
Route::middleware(['auth','roles:instructor'])->group(function(){
    ...
    Route::get('/api/counseling/{id}', [CounselingController::class, 'getSingle']);


// --- Counseling Routes for Instructor ---
Route::get('/instructor/counseling', [CounselingController::class, 'instructorIndex'])->name('instructor.counseling');
Route::post('/counseling/reply', [CounselingController::class, 'reply'])->name('counseling.reply');
Route::post('/counseling/update', [CounselingController::class, 'update'])->name('counseling.update');
...
Route::controller(CourseController::class)->group(function(){
    ...
    Route::post('/save-lecture', [CourseController::class, 'SaveLecture'])->name('save.lecture');
...
Route::get('/course-grid', [App\Http\Controllers\Frontend\IndexController::class, 'CourseGrid'])->name('course.grid');
...
// --- API route for getting single request data ---
