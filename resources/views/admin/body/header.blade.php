                            ...
                            <div class="header-notifications-list">
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Rahat 1<span class="msg-time float-end">5 sec
                                        ago</span></h6>
                                            <p class="msg-info">kichuna</p>
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item" href="javascript:;">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Rahat 1 <span class="msg-time float-end">14
                                        sec ago</span></h6>
                                            <p class="msg-info">demo</p>
                                        </div>
                                    </div>
                                </a>
