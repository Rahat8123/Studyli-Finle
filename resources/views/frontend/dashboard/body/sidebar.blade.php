        ...
        <div class="logo-box px-4">
            <a href="index.html" class="logo"><img src="{{ asset('frontend/images/logo.png') }}" alt="logo" style="width: 150px"></a>
        </div>
...
<li>
  <a href="{{ route('user.counseling') }}">
    <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 12c2.21 0 4-1.79 4-4S14.21 4 12 4 8 5.79 8 8s1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z"/></svg>
    Request Counseling
  </a>
</li>
