...
<div class="buy-course-btn-box">
    ...
    @elseif(Auth::check() && Auth::user()->role == 'instructor')
        <div class="alert alert-info">Instructors cannot enroll or pay for courses.</div>
    @elseif(Auth::check() && Auth::user()->role == 'admin')
        <div class="alert alert-info">Admins cannot enroll or pay for courses.</div>
    @else
        <a href="{{ route('login') }}" class="btn theme-btn w-100 mb-2">Login to enroll</a>
    @endif
</div>
