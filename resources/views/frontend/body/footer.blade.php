        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <a href="index.html">
                        <img src="{{ asset('frontend/images/logo.png') }}" alt="footer logo" class="footer__logo" style="width: 150px">
                    </a>
                    <ul class="generic-list-item pt-4">
                        <li><a href="tel:+1631237884">01737130511</a></li>
                        <li><a href="mailto:rayganulrahat8123@gmail.com">rayhanulrahat8123@gmail.com</a></li>
